# Andrrs' Neovim configuration

This is my Neovim configuration, based on [nkt148's config](https://github.com/ntk148v/neovim-config), although I have made several changes to it which may or may not be only useful to me, so if you find this config interesting, don't use it, use nkt148's config instead. It is a great starting point for your own configuration, sure was for me.

Below is nkt148's README, which I have not modified at all, so if you want to know more about the config, read it. It's very detailed, and has far more effort put into it than I could be bothered to do, so again hats off to nkt148 for the work they put into this.
